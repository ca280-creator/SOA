...
class AdminPage {
    ...
    /**
     * Metodă pentru înregistrarea în istoricul de utilizare
     ...
     */
    public function logActivity($utilizator, $rol, $actiune, $operatia_sql) {
        $query = "INSERT INTO istoric_utilizare (utilizator, rol, data_ora, actiune, operatia_sql) VALUES (?, ?, NOW(), ?, ?)";
    ...
    public function searchStudents($criteria, $sortColumn = 'id', $sortOrder = 'asc') {
        ...
        // Înregistrăm activitatea în istoric
        $actiune = $this->generateActionDescription($criteria, $sortColumn, $sortOrder);
        $this->logActivity('analist', 'analist', $actiune, $query);
    ...
    /**
     * Generează descrierea acțiunii pentru istoric
     * @param array $criteria Criteriile de căutare
     * @param string $sortColumn Coloana de sortare
     * @param string $sortOrder Ordinea sortării
     * @return string Descrierea acțiunii
     */
    private function generateActionDescription($criteria, $sortColumn, $sortOrder) {
        ...
        if ($hasSearchCriteria) {
            $searchDescription = "Căutare elevi cu criterii: " . implode(', ', $searchParts);
        } else {
            $searchDescription = "Vizualizare toți elevii";
        }
        
        $sortDescription = " - Sortare după $sortColumn ($sortOrder)";
        
        return $searchDescription . $sortDescription;
    }
...
// Încărcăm toți elevii la prima accesare (cu înregistrare în istoric)
...
<head>
    ...
    <title>Analizare Evaluare Națională</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header-section">
            <h1>Analizare Evaluare Națională</h1>
            <div class="nav-buttons">
                <a href="analist_cont_page.php" class="nav-btn">Contestații</a>
        ...
        <div class="activity-log">
            <strong>Informații utilizator:</strong> Analist (Rol: analist) - Toate operațiile sunt înregistrate în istoricul de utilizare
        </div>
